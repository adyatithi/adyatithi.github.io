...
description_en = '''
Beginning of `nabhasya-mAsaH`, marked by the transit of Sun into the 6th division of the tropical zodiac. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.
'''
