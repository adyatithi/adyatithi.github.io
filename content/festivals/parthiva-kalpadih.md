...
timing_summary = "Vaiśākha (वैशाख) māsa, Kṛṣṇa Pakṣa Tṛtīyā, at अपराह्णः"
...
description_en = '''
`pArthiva-kalpAdiH` is observed on this day. Performing `zrAddha` on this day gives `akSayatRpti` to `pitr`s. Although there are 30 Kalpadis described in various puranas, 7 of them are particularly special.
'''
