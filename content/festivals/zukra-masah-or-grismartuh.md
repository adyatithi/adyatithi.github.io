...
id_display = "śukra-māsaḥ òr grīṣmaṛtuḥ"
...
description_en = '''
Beginning of `zukra-mAsa`, marked by the transit of Sun into the 3rd division of the tropical zodiac.  Also marks the beginning of `grISmaRtuH`. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.
'''

[names]
sa = ["शुक्र-मासः/ग्रीष्मऋतुः"]
+++
