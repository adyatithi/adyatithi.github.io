...
description_en = '''
`uttarAyaNa-puNyakAlaH`. For `uttarAyaNa`, the 20 ghatikas succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
