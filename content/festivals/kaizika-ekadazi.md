...
description_en = '''
The Shukla-paksha Ekadashi of `vRzcikamAsa` is also celebrated as `kaizika-EkAdazI`. Kaisika Purāṇam, consisting of 82 shlokas describes the story of `nampADuvAn2` and a `rAkSasa` who attained mukti by `nAmasaGkIrtanam` and the fruits of `nampADuvAn`'s `nAmasaGkIrtanam`, respectively!
