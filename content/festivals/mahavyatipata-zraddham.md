...
description_en = '''
`vyatIpAta` is regarded as the king of `yOga`s. Though it occurs 13 times every year, the occurrences in `dhanurmAsa` and `mahAlayapakSa` are particularly sacred, and this day is special for propitiating the `pitR`s.
'''

[names]
sa = ["महाव्यतीपात-श्राद्धम्"]
+++
