...
description_en = '''
Tulā-Saṅkramaṇa Punyakala. Perform danam of rice/wheat/grains and cow ghee/curd etc. For `tulA-saGkramaNa-puNyakAla` the 10 ghatikas preceding and succeeding the `saGkramaNa` forms a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''

[names]
sa = ["तुला-सङ्क्रमण-पुण्यकालः"]
+++
