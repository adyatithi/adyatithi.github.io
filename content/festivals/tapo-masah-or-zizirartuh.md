...
id_display = "tapo-māsaḥ òr śiśiraṛtuḥ"
...
description_en = '''
Beginning of `tapO-mAsaH`, marked by the transit of Sun into into the 11th division of the tropical zodiac.  Also marks the end of `hEmantaRtuH` and the beginning of `ziziraRtuH`. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.  
Importantly, this also marks the beginning of `uttarAyaNam`, and the end of `dakSiNAyanam`. This also marks the winter solstice. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.
'''

[names]
sa = ["तपो-मासः/शिशिरऋतुः/उत्तरायणम्"]
+++
