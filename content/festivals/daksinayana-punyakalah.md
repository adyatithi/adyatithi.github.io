...
description_en = '''
`dakSiNAyana-puNyakAlaH`. For `dakSiNAyana`, the 30 ghatikas preceding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
