...
description_en = '''
Kanyā-Ravi-Saṅkramaṇa-Ṣaḍaśīti Punyakala. Perform danam of clothes/place to live. For `SaDazIti-puNyakAla` like `kanyA-saGkramaNa`, the 60 ghatikas succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''
