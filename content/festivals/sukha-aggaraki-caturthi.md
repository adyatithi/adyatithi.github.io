...
kaala = "dinamaana"
timing_summary = "Śukla Pakṣa Caturthī, at dinamaana"
...
description_en = '''
`caturthI tithi` on a Tuesday is as sacred as a solar eclipse. When it occurs in `zuklapakSa`, it is called `sukhA`. Good day for doing puja of Ganesha/Subrahmanya with naivedyam of modakam/millet flour respectively.
'''
