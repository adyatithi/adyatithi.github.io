...
id_display = "kārttika-māsa-antimatrayatithi-vratam 2"
slug = "karttika-masa-antimatrayatithi-vratam-2"
source_path = "general/lunar_month/tithi/08/14/kArttika-mAsa-antimatrayatithi-vratam~2.toml"
tags = ["LessCommonFestivals"]
month = ["08. Kārtika"]
tithi = ["Caturdaśī"]
category = ["General Observances"]
timing_summary = "Kārtika (कार्तिक) māsa, Śukla Pakṣa Caturdaśī"
...
description_en = '''
Last three days of `kArttika-mAsaH`. `anantaphaladam`! Perform Shiva/Vishnu Puja, Bhagavata Parayanam, BhagavadGita Parayanam, Vishnu Sahasranama Parayanam etc.
'''

[names]
sa = ["कार्त्तिक-मास-अन्तिमत्रयतिथि-व्रतम्"]
+++
