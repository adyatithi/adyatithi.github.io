...
description_en = '''
Meṣa-Saṅkramaṇa Punyakala. For `mEsa-saGkramaNa-puNyakAla` the 10 ghatikas preceding and succeeding the `saGkramaNa` forms a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''

[names]
sa = ["मेष-सङ्क्रमण-पुण्यकालः"]
+++
