...
id_display = "saho-māsaḥ òr hemantaṛtuḥ"
...
description_en = '''
Beginning of `sahO-mAsaH`, marked by the transit of Sun into the 9th division of the tropical zodiac. Also marks the beginning of `hEmantaRtuH`. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.
'''

[names]
sa = ["सहो-मासः/हेमन्तऋतुः"]
+++
