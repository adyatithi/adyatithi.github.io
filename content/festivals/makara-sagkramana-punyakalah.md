...
description_en = '''
Makara-Saṅkramaṇa Punyakala.  For `makara-saGkramaNa`, the 20 ghatikas succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''

[names]
sa = ["मकर-सङ्क्रमण-पुण्यकालः", "मकर-सङ्क्रान्तिः"]
+++
