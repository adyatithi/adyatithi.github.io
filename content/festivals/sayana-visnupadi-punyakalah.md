...
description_en = '''
`sAyana-viSNupadI-puNyakAla`. For `viSNupadI-puNyakAla`, the 16 ghatikas preceding and succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
