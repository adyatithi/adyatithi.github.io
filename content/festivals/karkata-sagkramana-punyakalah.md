...
description_en = '''
Karkaṭa-Saṅkramaṇa Punyakala.  Perform danam of ghee, milk vessel, “ghee cow” and fruits. For `karkaTa-saGkramaNa`, the 30 ghatikas preceding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''
