...
description_en = '''
Beginning of `Urja-mAsaH`, marked by the transit of Sun into the 8th division of the tropical zodiac. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.
'''
