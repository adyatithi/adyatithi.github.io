...
timing_summary = "Māgha (माघ) māsa, Śukla Pakṣa Trayodaśī, at अपराह्णः"
...
description_en = '''
`varAha-kalpAdiH` is observed on this day. Performing `zrAddha` on this day gives `akSayatRpti` to `pitr`s. Although there are 30 Kalpadis described in various puranas, 7 of them are particularly special.
'''
