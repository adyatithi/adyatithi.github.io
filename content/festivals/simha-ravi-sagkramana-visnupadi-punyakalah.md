...
description_en = '''
Siṃha-Ravi-Saṅkramaṇa-Viṣṇupadī Punyakala.  For `viSNupadI-puNyakAla` like `siMha-saGkramaNa`, the 16 ghatikas preceding and succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''

[names]
sa = ["सिंह-रवि-सङ्क्रमण-विष्णुपदी-पुण्यकालः"]
+++
