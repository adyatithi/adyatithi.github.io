...
tags = ["KalpadiDays", "LessCommonFestivals"]
month = ["12. Phālguna"]
tithi = ["Tṛtīyā"]
category = ["Calendrical Specials"]
kaala = "अपराह्णः"
priority_rule = "vyaapti"
timing_summary = "Phālguna (फाल्गुन) māsa, Kṛṣṇa Pakṣa Tṛtīyā, at अपराह्णः"
"references" = ["Smriti Kaustubham p.87--88"]
...
description_en = '''
`brahma-kalpAdiH` is observed on this day. Performing `zrAddha` on this day gives `akSayatRpti` to `pitr`s. Although there are 30 Kalpadis described in various puranas, 7 of them are particularly special.
'''
