...
timing_summary = "Kārtika (कार्तिक) māsa, Kṛṣṇa Pakṣa Saptamī, at अपराह्णः"
...
description_en = '''
`sAvitra-kalpAdiH` is observed on this day. Performing `zrAddha` on this day gives `akSayatRpti` to `pitr`s. Although there are 30 Kalpadis described in various puranas, 7 of them are particularly special.
'''

[names]
sa = ["सावित्री-कल्पादिः"]
+++
