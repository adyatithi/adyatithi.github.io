...
description_en = '''
Dhanur-Ravi-Saṅkramaṇa-Ṣaḍaśīti Punyakala. Perform danam of clothes/vehicle (e.g. bullock cart). For `SaDazIti-puNyakAla` like `dhanus-saGkramaNa`, the 60 ghatikas succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''
