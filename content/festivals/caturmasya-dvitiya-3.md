...
id_display = "cāturmāsya-dvitīyā 3"
slug = "caturmasya-dvitiya-3"
source_path = "devatA/pitR/lunar_month/tithi/12/17/cAturmAsya-dvitIyA~3.toml"
...
timing_summary = "Phālguna (फाल्गुन) māsa, Kṛṣṇa Pakṣa Dvitīyā, at अपराह्णः"
...
description_en = '''
Three `dvitIyA` tithis, in `ASADha`, `kArttika` and `phAlguna` are known as `cAturmAsya-dvitIyA`. These are `anadhyayana` days.
'''
