+++
title = "अनध्यायः"
id = "anadhyAyaH-cAturmAsya-dvitIyA-sAmAnya-niyamAH"
...
description_en = '''
On the `kRSNa-pakSa-dvitIyA` days in the months of `ASADha`, `kArtika` and `phAlguna`, one must not perform `adhyayana`.
'''
