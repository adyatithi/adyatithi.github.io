+++
title = "अनध्यायः"
id = "anadhyAyaH-cAturmAsya-prathamA-sAmAnya-niyamAH"
...
description_en = '''
One should not perform adhyayana for three days, commencing from the `pUrNimA` of the three months, `ASADha`, `kArtika` and `phAlguna`.
'''
