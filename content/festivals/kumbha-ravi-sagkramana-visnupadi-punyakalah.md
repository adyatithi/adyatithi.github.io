...
description_en = '''
Kumbha-Ravi-Saṅkramaṇa-Viṣṇupadī Punyakala. Perform danam of hay, grass, food and pure water to cows. For `viSNupadI-puNyakAla` like `kumbha-saGkramaNa`, the 16 ghatikas preceding and succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''
