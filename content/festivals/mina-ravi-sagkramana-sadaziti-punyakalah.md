...
description_en = '''
Mīna-Ravi-Saṅkramaṇa-Ṣaḍaśīti Punyakala. For `SaDazIti-puNyakAla` like `mIna-saGkramaNa`, the 60 ghatikas succeeding the `saGkramaNa`form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''

[names]
sa = ["मीन-रवि-सङ्क्रमण-षडशीति-पुण्यकालः"]
+++
