...
description_en = '''
Ṣaḍaśīti Punyakala. For `SaDazIti-puNyakAla`, the 60 ghatikas succeeding the `saGkramaNa` form a `puNyakAla`; in general, the ghatikas closer to the `puNyakAla` are even more sacred.
'''
