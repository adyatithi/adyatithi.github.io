...
id_display = "madhu-māsaḥ òr vasantaṛtuḥ"
...
description_en = '''
Beginning of `madhu-mAsaH`, marked by the transit of Sun into the 1st division of the tropical zodiac. Also marks the beginning of `vasantaRtuH`and the vernal equinox. While `nirayana saGkrAnti`'s are widely observed, tropical `saGkrAnti`'s are also equally sacred, and have similar `puNyakAla`s associated with them.
'''

[names]
sa = ["मधु-मासः/वसन्तऋतुः"]
+++
