...
timing_summary = "Caitra (चैत्र) māsa, Śukla Pakṣa Pañcamī, at अपराह्णः"
...
description_en = '''
`kUrma-kalpAdiH` is observed on this day. Performing `zrAddha` on this day gives `akSayatRpti` to `pitr`s. Although there are 30 Kalpadis described in various puranas, 7 of them are particularly special.
'''
