+++
title = "अनध्यायः"
id = "anadhyAyaH-cAturmAsya-tRtIyA-sAmAnya-niyamAH"
...
description_en = '''
On the `kRSNa-pakSa-tRtIyA` days in the months of `ASADha`, `kArtika` and `phAlguna`, one must not perform `adhyayana`, as also on `Azvayuk-zukla-dvitIyA`.
'''
